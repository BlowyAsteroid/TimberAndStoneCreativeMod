...
namespace Plugin.BlowyAsteroid.TimberAndStoneMod
{
    ...
    {
        public const String GOBLIN_UNARMED = "Goblin Unarmed";
        public const String GOBLIN_INFANTRY = "Goblin Infantry";
        public const String GOBLIN_ARCHER = "Goblin Archer";
        public const String SKELETON_UNARMED = "Skeleton Unarmed";
        ...
        public static EnemyUnit Goblin = new EnemyUnit(GOBLIN_UNARMED);
        ...
        public static EnemyUnit Skeleton = new EnemyUnit(SKELETON_UNARMED);
        ...
        {
            GoblinInfantry, GoblinArcher, Goblin, SkeletonInfantry, SkeletonArcher, Skeleton, Necromancer
        };
